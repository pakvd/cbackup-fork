...
public class Scheduler extends AbstractCoreUnit {
     ...
     * @return String    - command result
     */
    // @SshdShellCommand(value = "restart", description = "Restart scheduler. Usage: 'cbackup restart [-json]'") // Temporarily disabled
     ...
     * @return String    - command result
     */
    // @SshdShellCommand(value = "stop", description = "Stop scheduler. Usage: 'cbackup stop [-json]'") // Temporarily disabled
     ...
     * @return String    - command result
     */
    // @SshdShellCommand(value = "backup", description = "Single node backup. Usage: 'cbackup backup <NODE ID> [-json]'") // Temporarily disabled
     ...
     * @return String    - command result
     */
    // @SshdShellCommand(value = "runtask", description = "Run task by name. Usage: 'cbackup runtask <TASK NAME> [-json]'") // Temporarily disabled
     ...
     * @return String    - command result
     */
    // @SshdShellCommand(value = "status", description = "Get scheduler status. Usage: 'cbackup status [-json]'") // Temporarily disabled
     ...
     * @return String    - command result
     */
    // @SshdShellCommand(value = "version", description = "Get scheduler version. Usage: 'cbackup version [-json]'") // Temporarily disabled
