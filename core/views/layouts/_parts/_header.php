...
<header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
        ...
        <?php /* Убрана кнопка сворачивания sidebar */ ?>
                ...
                <ul class="dropdown-menu pull-right">
                    <li>
                        <a href="<?= \yii\helpers\Url::to(['/user/profile']) ?>">
                            <i class="fa fa-user"></i> <?= Yii::t('user', 'Profile') ?>
                        </a>
                    </li>
                    <li>
                        <a href="<?= \yii\helpers\Url::to(['/user/settings']) ?>">
                            <i class="fa fa-cog"></i> <?= Yii::t('app', 'Settings') ?>
                        </a>
                    </li>
                    <li class="divider"></li>
                    <li>
                        <?php
                            echo Html::a('<i class="fa fa-sign-out"></i> '.Yii::t('user', 'Logout'), ['/user/logout'], [
                                'data' => ['method' => 'post'],
                                'class' => 'nav-link',
                            ]);
                        ?>
