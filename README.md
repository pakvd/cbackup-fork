...
### Вариант 1: Автоматическая чистая установка (рекомендуется)

Для чистой установки с автоматической проверкой используйте скрипт:
...
### Вариант 2: Ручная установка с Makefile
...
# 3. Запустить контейнеры (автоматически установит права)
make up
...
# 6. Проверить синхронизацию (после веб-установки)
